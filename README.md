...
Also simpliest Text Search can be the bloom filter for reading with questions. With Wor2Vec you can read on Gbps actually. And process terabytes of texts with searching.
